...
Current accepted and pushed implementation head: `main@c405398`
...
| real multi-region coupled physics | local constitutive/interface residual/Jacobian, sampled point force balance, and regional volume-force observations only | not yet admissible as a solve | the accepted slices still lack independently established boundary-limit traces, a complete declared MHD jump ledger, typed regional test-function/source/boundary residual and Jacobian ownership, global conservation accounting, and a converged multi-region solve |
...
tracked replacements accepted and pushed through `ac00ab6`, `d527866`,
   ...
   `8ad464b`, `22d9a38`, `384091f`, `7eb8f80`, `8983daa`, and `c405398`.
...
control/fault compiler and trusted
  ...
  not a residual or conservation verdict. Full 3-D spatial-partition proof, declared-normal
