...
@testset "P0 contract refs and independent genome hashes" begin
    ...
    g = fixture_graph()
    m = MechanismGenomeV4(1, refs[1], _wrapper_payload())
    ...
    @test mechanism_hash(m) == mechanism_hash(MechanismGenomeV4(999, refs[1], _wrapper_payload()))
...
@testset "P0 negative controls and bounded large-graph canonicalization" begin
    ...
    registry = GenomeContractRegistryV4(refs...)
    m = MechanismGenomeV4(1, refs[1], _wrapper_payload()); f = FieldGeometryGenomeV4(2, refs[2], g)
    ...
    @test_throws MethodError MechanismGenomeV4(1, refs[1], g; invariants=(Any[1],))
    @test_throws ArgumentError FieldGeometryGenomeV4(2, refs[2], g; fields=(Dict(:mutable => true),))
    @test_throws MethodError MechanismGenomeV4(UInt64(1), refs[1], g, (MutablePayload([1]),), ())
    @test_throws MethodError MechanismGenomeV4(UInt64(1), refs[1], g, (MutableNumber(1),), ())
    @test_throws MethodError MechanismGenomeV4(UInt64(1), refs[1], g, (MutableText("mutable"),), ())
    ...
    @test_throws MethodError MechanismGenomeV4(1, refs[1], g; invariants=(opaque,))
