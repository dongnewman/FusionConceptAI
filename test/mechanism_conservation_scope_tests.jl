...
@testset "typed conservation scope constructors and canonical identity" begin
    ...
    @test_throws ArgumentError InvariantV1(InvariantRefV1("rogue"),
        ConservationLedgerIdentityV1(QualifiedRefV1("ledger", "v1"), Digest256(repeat("0", 64)), UnitSignature()),
        ScopeRogueV1(), (InvariantTermV1(state_a, 1),), (), (), (), 0, entropy_conserved)
...
@testset "scope alpha renames are synchronized graph closures" begin
    ...
    base_domain_invariant = InvariantV1(base_invariant.invariant_ref, base_invariant.ledger_identity,
        DomainConservationScopeV1((StateGeneRefV1("state-a"),)), base_invariant.terms,
        (), (), (), 0, entropy_conserved)
    base_domain = MechanismGenomePayloadV1(base_payload.states, (base_domain_invariant,),
    ...
    renamed_domain_invariant = InvariantV1(renamed_base.invariant_ref, renamed_base.ledger_identity,
        DomainConservationScopeV1((StateGeneRefV1("renamed-state-a"),)), renamed_base.terms,
        (), (), (), 0, entropy_conserved)
    renamed_domain = MechanismGenomePayloadV1(renamed_payload.states, (renamed_domain_invariant,),
    ...
    base_interface_invariant = InvariantV1(InvariantRefV1("interface-alpha"), base_flux,
        InterfaceConservationScopeV1(OperatorSiteRefV1("interface-a")), base_invariant.terms,
        (), (), (), 0, entropy_conserved)
    base_interface = MechanismGenomePayloadV1(base_payload.states, (base_interface_invariant,),
        base_payload.operator_graph, base_payload.parameters, base_payload.symmetries,
        base_payload.observables, base_payload.operator_holes)
    ...
    renamed_interface_invariant = InvariantV1(InvariantRefV1("renamed-interface-alpha"), renamed_flux,
        InterfaceConservationScopeV1(OperatorSiteRefV1("renamed-interface-a")), renamed_base.terms,
        (), (), (), 0, entropy_conserved)
    renamed_interface = MechanismGenomePayloadV1(renamed_payload.states, (renamed_interface_invariant,),
        renamed_payload.operator_graph, renamed_payload.parameters, renamed_payload.symmetries,
        renamed_payload.observables, renamed_payload.operator_holes)
...
@testset "scope payload closure and layer boundaries" begin
    ...
    domain = InvariantV1(base.invariant_ref, base.ledger_identity,
        DomainConservationScopeV1((StateGeneRefV1("state-a"),)), base.terms,
        base.allowed_source_refs, base.allowed_sink_refs, base.boundary_flux_refs,
        base.tolerance_log10, base.entropy_direction)
    domain_payload = MechanismGenomePayloadV1(payload.states, (domain,), payload.operator_graph,
    ...
    @test_throws ArgumentError MechanismGenomePayloadV1(payload.states,
        (InvariantV1(base.invariant_ref, base.ledger_identity,
            DomainConservationScopeV1((StateGeneRefV1("state-a"),)),
            (InvariantTermV1(StateGeneRefV1("state-b"), 1),),
            base.allowed_source_refs, base.allowed_sink_refs, base.boundary_flux_refs,
            base.tolerance_log10, base.entropy_direction),), payload.operator_graph,
        payload.parameters, payload.symmetries, payload.observables, payload.operator_holes)
    ...
    interface = InvariantV1(InvariantRefV1("interface-invariant"), flux_identity,
        InterfaceConservationScopeV1(OperatorSiteRefV1(interface_edge.edge_id)), base.terms,
        (), (), (), 0, entropy_conserved)
    interface_payload = MechanismGenomePayloadV1(payload.states, (interface,), payload.operator_graph,
        payload.parameters, payload.symmetries, payload.observables, payload.operator_holes)
    @test interface_payload.invariants[1].scope isa InterfaceConservationScopeV1
    @test_throws ArgumentError MechanismGenomePayloadV1(payload.states,
        (InvariantV1(InvariantRefV1("wrong-interface"), base.ledger_identity,
            InterfaceConservationScopeV1(OperatorSiteRefV1("additive")), base.terms,
            (), (), (), 0, entropy_conserved),), payload.operator_graph,
        payload.parameters, payload.symmetries, payload.observables, payload.operator_holes)
    @test_throws ArgumentError MechanismGenomePayloadV1(payload.states,
        (InvariantV1(InvariantRefV1("dangling-domain"), base.ledger_identity,
            DomainConservationScopeV1((StateGeneRefV1("missing-state"),)), base.terms,
            (), (), (), 0, entropy_conserved),), payload.operator_graph,
        payload.parameters, payload.symmetries, payload.observables, payload.operator_holes)
    ...
    @test_throws ArgumentError MechanismGenomePayloadV1(payload.states,
        (InvariantV1(InvariantRefV1("nonstate-domain"), base.ledger_identity,
            DomainConservationScopeV1((StateGeneRefV1("nonstate"),)), base.terms,
            (), (), (), 0, entropy_conserved),), nonstate_graph,
        payload.parameters, payload.symmetries, payload.observables, payload.operator_holes)
    @test_throws ArgumentError MechanismGenomePayloadV1(payload.states,
        (InvariantV1(InvariantRefV1("dangling-interface"), flux_identity,
            InterfaceConservationScopeV1(OperatorSiteRefV1("missing-edge")), base.terms,
            (), (), (), 0, entropy_conserved),), payload.operator_graph,
        payload.parameters, payload.symmetries, payload.observables, payload.operator_holes)
    @test_throws ArgumentError MechanismGenomePayloadV1(payload.states,
        (InvariantV1(InvariantRefV1("wrong-ledger-interface"), base.ledger_identity,
            InterfaceConservationScopeV1(OperatorSiteRefV1("interface-a")), base.terms,
            (), (), (), 0, entropy_conserved),), payload.operator_graph,
        payload.parameters, payload.symmetries, payload.observables, payload.operator_holes)

    # A domain member is a structural relation, while a local alpha rename is not.
    domain_all = InvariantV1(base.invariant_ref, base.ledger_identity,
        DomainConservationScopeV1((StateGeneRefV1("state-a"), StateGeneRefV1("state-b"))), base.terms,
        base.allowed_source_refs, base.allowed_sink_refs, base.boundary_flux_refs,
        base.tolerance_log10, base.entropy_direction)
    all_payload = MechanismGenomePayloadV1(payload.states, (domain_all,), payload.operator_graph,
        payload.parameters, payload.symmetries, payload.observables, payload.operator_holes)
    ...
    renamed_payload = MechanismGenomePayloadV1((renamed_state, payload.states[2]), (domain,),
    ...
    interface_a = InvariantV1(InvariantRefV1("interface-invariant"), flux_identity,
        InterfaceConservationScopeV1(OperatorSiteRefV1("interface-a")), base.terms,
        (), (), (), 0, entropy_conserved)
    interface_b = InvariantV1(InvariantRefV1("interface-invariant"), flux_identity,
        InterfaceConservationScopeV1(OperatorSiteRefV1("interface-b")), base.terms,
        (), (), (), 0, entropy_conserved)
    interface_a_payload = MechanismGenomePayloadV1(payload.states, (interface_a,), payload.operator_graph,
        payload.parameters, payload.symmetries, payload.observables, payload.operator_holes)
    interface_b_payload = MechanismGenomePayloadV1(payload.states, (interface_b,), payload.operator_graph,
        payload.parameters, payload.symmetries, payload.observables, payload.operator_holes)
